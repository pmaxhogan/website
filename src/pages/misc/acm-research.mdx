...
tags: [js,node,firebase,python,web,tensorflow,ai,ml,collaborative,heroku]
...
In a collaborative research project as part of [ACM Research](https://cs.utdallas.edu/utd-acm-research-spring2021/), my team analyzed language trends with a mobile keyboard next-word prediction model. Our team was deemed the winner of the research competition.  
