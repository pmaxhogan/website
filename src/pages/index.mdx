...
## Games
<ProjectList list={props.data.allMdx.edges} filter="game" />

## CLI Apps
<ProjectList list={props.data.allMdx.edges} filter="cli" />

## Joke Projects
<ProjectList list={props.data.allMdx.edges} filter="joke" />
